...
knit: (function(input_file, encoding) {
  ...
  rmarkdown::render(input_file,
    encoding=encoding,
    output_file=file.path(dirname(input_file), out_dir, 'AnimatedF1.html'))})
...
* As we show elsewhere, the `r metric.name` contours describe a series of lines which intersect at $(\mathrm{FPR}, \mathrm{TPR}) = \left(0,-\tfrac{p}{n}\right)$.
