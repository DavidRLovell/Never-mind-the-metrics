---
title: "Animation of Balanced Accuracy"
...
knit: (function(input_file, encoding) {
  ...
  rmarkdown::render(input_file,
    encoding=encoding,
    output_file=file.path(dirname(input_file), out_dir, 'AnimatedBA.html'))})
...
* As we show elsewhere, the `r metric.name` contours describe a series of planar parallel lines in ROC space that are independent of class balance.
