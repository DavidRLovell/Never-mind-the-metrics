...
subtitle: "Supplementary Information - All Figures and R Markdown"
author: "David Lovell"
date: "29/05/2022"
...
This document provides the RMarkdown behind the figures and interactive visualisations in our paper for anyone who wants to see how they were created or who wishes to extend them. Some of these figures link to the [Desmos Graphing Calculator](https://www.desmos.com/). Desmos automatically ensures that the underlying code is available to copy and develop further and we provide RMarkdown for all other figures.
...
# Interactive visualisation of ROC and Precision-Recall reference points
